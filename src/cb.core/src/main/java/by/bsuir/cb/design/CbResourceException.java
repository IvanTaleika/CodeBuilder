...
// TODO remove in some other package?
public class CbResourceException extends Exception {

  /**
   * Serialization ID.
   */
  private static final long serialVersionUID = -2368128156097554339L;
   ...
   */
  public CbResourceException(final String message) {
    super(message);
  }
   ...
   *        unknown.)
   */
  public CbResourceException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   *        unknown.)
   */
  public CbResourceException(final Throwable cause) {
    super(cause);
  }
