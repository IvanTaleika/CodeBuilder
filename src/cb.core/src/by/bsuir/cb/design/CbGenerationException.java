...
// TODO move to code generator class
public class CbGenerationException extends Exception {
   ...
   */
  public CbGenerationException(final String message) {
    super(message);
  }
   ...
   *        unknown.)
   */
  public CbGenerationException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   *        unknown.)
   */
  public CbGenerationException(final Throwable cause) {
    super(cause);
  }
